...
export const trustLog: TrustEntry[] = [
  ...
  { ts: "21 апр · 22:47", msgHtml: "<b>AMS-1</b> · замена SFP-модуля на агрегации", tag: "OK" },
  { ts: "18 апр · 04:11", msgHtml: "<b>ZRH-1</b> · перезапуск хоста, 42 сек простоя", tag: "WARN" },
  ...
  { ts: "22 мар · 07:40", msgHtml: "<b>SE</b> · открыта локация Стокгольм, 12 стоек", tag: "OK" },
];
